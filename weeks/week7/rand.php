...
//if we throw a double -- double 6, we will wind big!
//if we just throw a double, we will still win
//no double, no win
$dice1a = rand(1,6);
$dice2a = rand(1,6);
if($dice1a == 6 && $dice2a == 6 ) {
    echo '<b>Dice 1:</b> '.$dice1a.' <br>';  
    echo '<b>Dice 2:</b> '.$dice2a .' ';
    echo '<h2>Jackpot! Winner winner chicken dinner!</h2>';
...
echo '<h2>Using rand() to display images</h2>';
$photos[0] = 'photo1';
$photos[1] = 'photo2';
$photos[2] = 'photo3';
$photos[3] = 'photo4';
