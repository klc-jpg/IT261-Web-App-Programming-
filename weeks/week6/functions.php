...
echo '<h2>How do we deal with arrays? Use indexed arrays!!</h2>';
...
echo '<h2>The logic behind the wines on our form</h2>
        <p> 
            If post wines is not empty, take post wines and implode() them, create a new variable named
            $my_wines as a result.
        </P> 
